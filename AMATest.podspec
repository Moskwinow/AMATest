...
spec.homepage     = "https://github.com/Moskwinow/AMATest"
...
spec.source       = { :git => "https://github.com/Moskwinow/AMATest.git", :tag => "#{spec.version}" }
...
spec.source_files  = "AMATest/**/*.{h,m,swift}"
